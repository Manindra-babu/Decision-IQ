...
function NavLink({ active, onClick, text, className }) {
  ...
  return (
    ...
    <button
      ...
      className={`relative px-4 py-2 transition-colors duration-200 font-bold uppercase tracking-widest text-[10px] ${

        active ? 'text-slate-900 dark:text-white' : 'text-slate-500 hover:text-[var(--c-primary)]'
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  ...
                  <div className="absolute right-0 mt-3 w-48 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-sm shadow-xl z-50 py-2 animate-pop-in">
                    ...
                    <button onClick={() => { navigate('settings'); setIsProfileOpen(false); }} className="flex items-center px-4 py-2.5 text-[10px] font-bold uppercase text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 w-full text-left"><SettingsIcon size={14} className="mr-3" /> Settings</button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col items-center justify-center relative z-20 border-y border-slate-300 dark:border-slate-800 py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300">
            ...
            <button onClick={() => navigate('goal-overview')} className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 text-slate-900 dark:text-white px-10 py-4 rounded-sm font-bold text-[11px] uppercase tracking-widest">Learn More</button>
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 relative z-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        ...
        <button onClick={() => navigate('assistant')} className="glass-panel text-[var(--c-primary)] px-5 py-2.5 rounded-sm font-bold text-sm uppercase tracking-wider flex items-center space-x-2 transition-all hover:-translate-y-1">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="glass-panel p-8 rounded-sm shadow-xl border border-slate-300 dark:border-slate-800 h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <DetailsSection icon={<BookOpen size={14}/>} title="Resources" list={activeNode.details.resources} />

              <DetailsSection icon={<Award size={14}/>} title="Certifications" list={activeNode.details.certifications} />

              <div className="md:col-span-2"><DetailsSection icon={<Briefcase size={14}/>} title="Projects" list={activeNode.details.projects} grid /></div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-12 relative z-10 animate-fade-in-up pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-2">
          ...
          <SettingsTab active={activeTab === 'general'} onClick={() => setActiveTab('general')} icon={<SettingsIcon size={16}/>} label="General" />
...
function SettingsField({ label, val, setVal }) {
  ...
  return (
    ...
    <div className="space-y-2">
      ...
      <input type="text" value={val} onChange={(e) => setVal(e.target.value)} className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-sm p-3 text-sm font-bold text-slate-900 dark:text-white focus:border-[var(--c-primary)] outline-none transition-all shadow-sm" />
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-12 relative z-10 animate-fade-in-up">
      ...
      <div className="glass-panel rounded-sm overflow-hidden shadow-xl border border-slate-300 dark:border-slate-800">
        ...
        <div className="flex border-b dark:border-slate-800">
          ...
          <TabBtn active={activeTab === 'ai'} onClick={() => setActiveTab('ai')} icon={<BrainCircuit size={18}/>} label="AI Recommendation" />
